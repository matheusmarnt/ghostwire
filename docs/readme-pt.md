...
Veja [`SECURITY.md`](SECURITY.md) e [`/docs/security`](https://matheusmarnt.github.io/ghostwire/docs/security/). Nenhum dado do DOM sai do navegador; o aprendizado é feito localmente; telemetria zero.
