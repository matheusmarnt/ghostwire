...
- **Atributo `#[Ghost]`** — a nivel de clase o método, con una cascada de precedencia de 7 niveles (método → clase → heredado → directiva → config → valor predeterminado del paquete), sin ningún cambio en la vista
